...
Hệ thống Web Progressive App (PWA) hiện đại hỗ trợ lực lượng **Cảnh sát Giao thông (CSGT) Việt Nam** sử dụng camera di động quét, phát hiện phương tiện bằng mô hình AI YOLOv11 và chạy OCR tự động thông qua trí tuệ nhân tạo **Gemini 3.5 Flash** độ chính xác cao (&ge;95%). 
...
1. **Quét Camera Nhận Diện Realtime (YOLO & Gemini OCR)**
